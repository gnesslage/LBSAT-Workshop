...
Topic=c("Introduction","Simple methods","Length-frequency analysis","Stage-based modeling","Intro to statistical modeling","GUEST - Yan Li, NCDENR (blue crab & spotted sea trout models)","GUEST - Mike Wilberg, UMCES CBL (Chesapeake Bay spatial oyster model)","Statistical catch-at-length models (cont'd)","GUEST - Jeff Kipp, ASMFC (American lobster model)","Age-length hybrid models","GUEST - Cody Szuwalkski, NOAA (West Coast crab models)","GUEST -  Katie Drew, ASMFC (northern shrimp model)","More examples & wrap up")
